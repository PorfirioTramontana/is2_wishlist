...
class DeleteItem(unittest.TestCase):
    ...
    def test_delete_item(self):
        ...
        driver.find_element_by_css_selector("[x-test-tpl-70] [x-test-hook-80] [x-test-tpl-11] [x-test-hook-32]").click()
        driver.find_element_by_css_selector("[x-test-tpl-70] [x-test-hook-80] [x-test-tpl-11] [x-test-hook-32]").clear()
        driver.find_element_by_css_selector("[x-test-tpl-70] [x-test-hook-80] [x-test-tpl-11] [x-test-hook-32]").send_keys("Air Pods")
