...
class SignupOK(unittest.TestCase):
    ...
    def test_signup_o_k(self):
        ...
        driver.find_element_by_name("email").send_keys("me@antonio.engineer")
    ...
    def test_signup_k_o_duplication_error(self):
        ...
        driver.find_element_by_name("email").click()
        driver.find_element_by_name("email").clear()
        driver.find_element_by_name("email").send_keys("w0nd3rby@gmail.com")
        driver.find_element_by_name("password").clear()
        driver.find_element_by_name("password").send_keys("testme")
        driver.find_element_by_xpath("//form/button/span").click()
    ...
    def test_signup_k_o_bad_email(self):
        ...
        driver.find_element_by_name("email").click()
        driver.find_element_by_name("email").clear()
        driver.find_element_by_name("email").send_keys("me@antonioengineer")
        driver.find_element_by_name("password").clear()
        driver.find_element_by_name("password").send_keys("testme")
        driver.find_element_by_xpath("//form/button/span").click()
