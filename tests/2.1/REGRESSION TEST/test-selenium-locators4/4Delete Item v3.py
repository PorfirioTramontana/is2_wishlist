...
class DeleteItem(unittest.TestCase):
    ...
    def test_delete_item(self):
        ...
        driver.find_element_by_xpath("//div[3]/input").send_keys("Air Pods")
        ...
        driver.find_element_by_xpath("//div[4]/mat-form-field/div/div/div[3]/input").send_keys("Air Pods by Apple")
